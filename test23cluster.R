# 계층적 군집분석 : 거리 개념을 기본으로 군집화를 할 때 가까운 data끼리 순차적으로 
# 군집(cluster)을 형성해가는 응집형 계층적 군집화
# dist(), hclust()
...
text(xy[,1], xy[,2], 
     labels = abbreviate(rownames(xy)),cex = 0.8, pos = 1, col = "blue")
dist(xy, method = 'euclidean') ^ 2   # 정수로 확인
