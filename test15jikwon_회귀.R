...
install.packages("lubridate")   # 날짜와 시간관련
...
cor(jik_data$jik_workyear,jik_data$jik_pay)  # 0.9196725 상관관계 확인
# 인과관계?
...
abline(model, col='red',lwd=2) # 추세선 긋기
