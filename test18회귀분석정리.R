# mtcars dataset 으로 단순 / 다중 선형회귀 분석 모델 
...
# hp : 독립변수 (연속형 data), mpg : 종속변수(연속형)

cor(mtcars$hp, mtcars$mpg)    # -0.7761684이고 두 변수는 인과관계임 
...
summary(model1)     # p-value: 1.788e-07 < 0.05 유의한 model, R-squared:  0.6024
...
# hp,wt : 독립변수 (연속형 data), mpg : 종속변수(연속형)
